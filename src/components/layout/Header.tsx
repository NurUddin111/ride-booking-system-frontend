      ...
      <div className="flex h-16 items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-6">
            ...
            <a
              href="#"
              className="text-primary hover:text-primary/90 flex gap-2 items-center"
            >
              <Logo />
              <h1 className="text-4xl font-mono font-semibold">Safari</h1>
            </a>
            {/* Navigation menu */}
              ...
              <NavigationMenuList className="gap-2">
                {navigationLinks.map((link, index) => (
                  <NavigationMenuItem key={index}>
                    {link.submenu ? (
                      <>
                        <NavigationMenuTrigger className="bg-transparent px-2 py-1.5 font-medium text-foreground hover:text-primary *:[svg]:-me-0.5 *:[svg]:size-3.5">
                          {link.label}
                        </NavigationMenuTrigger>
